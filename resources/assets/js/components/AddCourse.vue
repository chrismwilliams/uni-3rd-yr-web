    ...
    <div v-if="foundPlace">
      <div class="field">
        ...
        <div class="control has-icons-left">
          <input
            ...
            @keydown="form.errors.clear('course')"
            required
          >
          <span class="icon is-small is-left">
        ...
        <div class="file has-name is-fullwidth">
          <label class="file-label">
            ...
            <span class="file-cta">
              ...
              <span class="file-label">Please Selete An Image…</span>
            </span>
            <span class="file-name" v-if="imgName">{{ imgName.substring(0,30) }}</span>
          </label>
        </div>
      ...
      <div class="field">
        ...
        <div class="control has-icons-left">
          <input
            class="input"
            :class="{ 'is-danger': form.errors.has('lat') }"
            id="lat"
            name="lat"
            type="text"
      ...
      <div class="field">
        ...
        <div class="control has-icons-left">
          <input
            class="input"
            :class="{ 'is-danger': form.errors.has('lng') }"
            id="lng"
            name="lng"
            type="text"
      ...
      <div class="field">
        ...
        <div class="control has-icons-left">
          <input
            class="input"
            :class="{ 'is-danger': form.errors.has('tel_no') }"
            id="tel"
            name="tel_no"
            type="text"
            v-model.trim="form.tel_no"
            required
          >
          <span class="icon is-small is-left">
        ...
        <p
          v-if="form.errors.has('tel_no')"
          class="help is-danger"
          v-text="form.errors.get('tel_no')"
        ></p>
      </div>
      ...
      <div class="field">
        ...
        <div class="control has-icons-left">
          <input
            class="input"
            :class="{ 'is-danger': form.errors.has('website') }"
            id="website"
            name="website"
            type="text"
      ...
      <div class="field is-grouped form_tags" v-if="tags">
        ...
        <p
          ...
          class="tag_error help is-danger"
          v-text="form.errors.get('tags')"
        ></p>
      </div>
      ...
      <div class="field">
        ...
        <div class="control has-icons-left">
          <input
            class="input"
            :class="{ 'is-danger': form.errors.has('weekday_cost') }"
            id="weekCost"
            name="weekday_cost"
            type="text"
            placeholder="20.50"
            v-model.trim="form.weekday_cost"
            required
          >
          <span class="icon is-small is-left">
        ...
        <p
          v-if="form.errors.has('weekday_cost')"
          class="help is-danger"
          v-text="form.errors.get('weekday_cost')"
        ></p>
      </div>
      ...
      <div class="field">
        ...
        <div class="control has-icons-left">
          <input
            class="input"
            :class="{ 'is-danger': form.errors.has('weekend_cost') }"
            id="weekendCost"
            name="weekend_cost"
            type="text"
            placeholder="30.50"
            v-model.trim="form.weekend_cost"
            required
          >
          <span class="icon is-small is-left">
            <i class="fas fa-pound-sign"></i>
        ...
        <p
          v-if="form.errors.has('weekend_cost')"
          class="help is-danger"
          v-text="form.errors.get('weekend_cost')"
        ></p>
      </div>
